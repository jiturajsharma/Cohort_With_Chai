...
import { getHiteshSirChat } from "../generative/Hiteshsir";
            ...
            <div className="h-[15%] px-[250px] flex gap-x-[10px]">
                <div className="h-[100%] w-[100%] flex justify-between items-center bg-white/10 px-[50px] rounded-2xl overflow-hidden">
                    <input
                        ...
                        placeholder="Ask Hitesh Choudhary"
                        onKeyDown={(e) => e.key === "Enter" && HResponse()}
                    />
                    <button onClick={HResponse} disabled={loading}>
